...
// var fs = require('fs');
// var JPH = fs.readFileSync(__dirname + '/../../../dist/JPH.jade', 'utf8');
// console.log(JPH);
...
$('[data-control="interactive"]').forEach(function (control) {
  ...
  var js = _('[data-control="input-js"]', control) || {textContent: '{ pageTitle: "Jade", youAreUsingJade: true, basedir: "/", filename: "index.jade"}'};
